          ...
          <div className="pic" ref={heroAvatarRef} style={{ transformStyle: 'preserve-3d' }}>
            <div className="term">
              ...
              <div className="term-body">
                ...
                <div>&nbsp;&nbsp;<span className="k">"linkedin"</span><span className="c">:</span>{' '}
                  <a className="s" href="https://www.linkedin.com/in/akshaya-s-it" target="_blank" rel="noopener noreferrer">"@akshaya-s-it"</a><span className="c">,</span>
                </div>
                <div>&nbsp;&nbsp;<span className="k">"vercel"</span><span className="c">:</span>{' '}
                  <a className="s" href="https://vercel.com/akshayas-projects-2303b88c" target="_blank" rel="noopener noreferrer">"@akshayas-projects"</a><span className="c">,</span>
                </div>
          ...
          <div className="explore-left">
            ...
            <div className="explore-meta-list">
              ...
              <div className="meta-item">
                ...
                <a className="meta-link" href="https://www.linkedin.com/in/akshaya-s-it" target="_blank" rel="noopener noreferrer">in/akshaya-s-it ↗</a>
              </div>
              <div className="meta-item">
                <span className="meta-label">GitHub:</span>
                <a className="meta-link" href="https://github.com/akshayasenthil004" target="_blank" rel="noopener noreferrer">@akshayasenthil004 ↗</a>
              </div>
              <div className="meta-item">
                <span className="meta-label">Vercel:</span>
                <a className="meta-link" href="https://vercel.com/akshayas-projects-2303b88c" target="_blank" rel="noopener noreferrer">akshayas-projects ↗</a>
              </div>
            </div>
        ...
        <div className="contact-wrapper">
          ...
          <div className="contact-info">
            ...
            <div className="socials">
              <MagneticButton>
                <a href="https://www.linkedin.com/in/akshaya-s-it" target="_blank" rel="noopener noreferrer" title="LinkedIn Profile" aria-label="LinkedIn Profile">
              ...
              <MagneticButton>
                <a href="https://github.com/akshayasenthil004" target="_blank" rel="noopener noreferrer" title="GitHub Profile" aria-label="GitHub Profile">
              ...
              <MagneticButton>
                <a href="https://vercel.com/akshayas-projects-2303b88c" target="_blank" rel="noopener noreferrer" title="Vercel Projects" aria-label="Vercel Projects">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M12 1L24 22H0L12 1Z"/></svg>
                </a>
              </MagneticButton>
            </div>
          </div>
